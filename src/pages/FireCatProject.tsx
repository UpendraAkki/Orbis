...
const FireCatProject = () => {
  return (
    <ProjectPageLayout
      ...
      darkMode={true}
    >
              <h2 className="text-3xl font-bold mb-6">Case Study: FireCat's 6th SENSE by Orbis</h2>
      ...
      <p>
                  Orbis provided an end-to-end solution called the 6th SENSE, combining sophisticated AI-driven 
